...
export class SidebarService {
  ...
  getSideBar(): SideBar[] {
    return [
      ...
      { image: 'sidebar_search', type: 'dark', id: 1, label: 'Búsqueda' },
      ...
      { image: 'sidebar_statistics', type: 'dark', id: 3, label: 'Estadísticas' },
      { image: 'sidebar_form', type: 'dark', id: 4, label: 'Formulario' }
    ];
  }
}
